...
export default function Profile() {
  ...
  const handleCSVSubmit = async (e) => {
    ...
    if (!Object.values(files).some(Boolean)) {
      setCsvError("Upload at least one CSV.");
      return;
    }

    if (!accessToken) {
      setCsvError("Not authenticated.");
      return;
    }
          ...
          <div className="profile-import-row">
            <div className="profile-import-col">
              ...
              <p className="profile-strip-description">
                ...
                Upload your CSV files below to unlock your <strong>all-time stats report</strong> and
                an <strong>initial weekly stats report</strong>.
              </p>
            ...
            <div className="profile-import-col">
              ...
              <form onSubmit={handleRSSSubmit}>
                ...
                >
                  {!savedRssUsername ? "SYNC NOW" : syncLoading ? "SYNCING..." : "SYNC NOW"}
                </button>
              </form>
            </div>
          </div>
